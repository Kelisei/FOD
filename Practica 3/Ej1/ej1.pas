...
procedure bajaFisica(var mae: archivo);
var
    pos:integer; aux:empleado;
begin
    Reset(mae);
    WriteLn('Introduzca la posicion a borrar');
    Readln(pos);
...
begin
  ...
  WriteLn('7-Eliminar en posicion');
  Writeln('8-salir');
end;
procedure menu_2();
begin
...
Begin
  ...
  while (num <>8) do begin
    Case (num) Of 
      ...
      7: begin denominarArchivo(arch); bajaFisica(arch); end;
    Else writeln('No es una opcion valida, intente nuevamente!...');
